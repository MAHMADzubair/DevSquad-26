...
export default function SellForm() {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-8 w-full max-w-[800px] mx-auto pb-40">
            ...
            <div className="bg-[#F1F2FF] rounded-[10px] p-5 sm:p-8 md:p-12 flex flex-col shadow-sm">
                <div className="mb-8 md:mb-10">
                    <h3 className="text-[22px] md:text-[28px] font-bold text-black font-[family-name:var(--font-sans)] leading-none inline-block relative pb-2 uppercase tracking-tight">
                        Car Details
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8 mb-8">
                    ...
                    {/* Year */}
                    <div className="flex flex-col gap-3">
                        <label className="text-[16px] md:text-[20px] font-medium text-black">Year*</label>
                    ...
                    {/* Make */}
                    <div className="flex flex-col gap-3">
                        <label className="text-[16px] md:text-[20px] font-medium text-black">Make*</label>
                        <div className="relative">
                    ...
                    {/* Model */}
                    <div className="flex flex-col gap-3">
                        <label className="text-[16px] md:text-[20px] font-medium text-black">Model*</label>
                        <div className="relative">
                    ...
                    <div className="flex flex-col gap-3">
                        <label className="text-[16px] md:text-[20px] font-medium text-black">Category*</label>
                        <div className="relative">
                    ...
                    {/* Mileage */}
                    <div className="flex flex-col gap-3">
                        <label className="text-[16px] md:text-[20px] font-medium text-black">Mileage (in miles)</label>
                    ...
                    {/* Engine Size */}
                    <div className="flex flex-col gap-3">
                        <label className="text-[16px] md:text-[20px] font-medium text-black">Engine size</label>
                        <div className="relative">
                    ...
                    {/* Paint */}
                    <div className="flex flex-col gap-3">
                        <label className="text-[16px] md:text-[20px] font-medium text-black">Paint*</label>
                        <div className="relative">
                    ...
                    {/* Has GCC Specs */}
                    <div className="flex flex-col gap-3">
                        <label className="text-[16px] md:text-[20px] font-medium text-black">Has GCC Specs</label>
                        <div className="relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8 mb-8">
                    {/* Accident History */}
                    <div className="flex flex-col gap-3">
                        <label className="text-[16px] md:text-[20px] font-medium text-black">Accident History</label>
                        <div className="relative">
                    ...
                    <div className="flex flex-col gap-3">
                        <label className="text-[16px] md:text-[20px] font-medium text-black">Full Service History</label>
                        <div className="relative">
                    ...
                    <div className="flex flex-col gap-3">
                        <label className="text-[16px] md:text-[20px] font-medium text-black">Has the car been modified?</label>
                    ...
                    <div className="flex flex-col gap-3">
                        <label className="text-[16px] md:text-[20px] font-medium text-black">Min Starting Bid*</label>
                        <div className="relative">
                ...
                <div className="flex flex-col gap-6 mb-10 pt-4">
                    <label className="text-[20px] md:text-[24px] font-bold text-black uppercase tracking-tight">Upload Photos</label>
