...
export default function AuctionListItem({
    ...
    return (
        <div className="group relative bg-white border border-[#EAECF3] rounded-[5px] overflow-hidden flex flex-col md:flex-row hover:shadow-xl transition-all duration-500 mb-8 w-full min-h-[196px]">
            ...
            <div className="relative w-full md:w-[280px] lg:w-[320px] h-[220px] md:h-auto bg-white overflow-hidden flex-shrink-0">
                {isTrending && (
            ...
            <div className="flex-1 flex flex-col relative">
                ...
                <div className="p-5 flex flex-col md:flex-row gap-6 h-full">
                    ...
                    <div>
                        ...
                        <div className="pt-6 md:pt-4 md:flex md:justify-end mt-auto">
                            <Link href={`/car/${id}`} className="w-full md:w-auto">
                                <button className={`w-full md:min-w-[280px] lg:w-[420px] h-[46px] border border-[#2E3D83] rounded-[5px] ${isOwner ? "bg-[#2E3D83]/10 text-[#2E3D83]" : "text-[#2E3D83] hover:bg-[#2E3D83] hover:text-white"} text-[16px] md:text-[18px] font-bold transition-all transform active:scale-[0.98] uppercase tracking-wide`}>
