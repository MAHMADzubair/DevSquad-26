...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-dark-bg p-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-slate-950 to-black overflow-hidden relative">
      ...
      <form onSubmit={login} className="glass p-8 rounded-2xl w-full max-w-sm animate-fade-in relative z-10">
        <h2 className="text-4xl font-extrabold mb-8 text-center tracking-tight">
          <span className="gradient-text">Sign In</span>
        </h2>

        {error && (
          <div className="bg-red-500/10 border border-red-500/20 text-red-500 text-sm px-4 py-3 rounded-lg mb-6 flex items-center gap-2">
        ...
        <p className="text-sm text-center mt-8 text-text-muted">
          ...
          <Link to="/register" className="text-primary hover:text-primary-hover ml-1 font-semibold transition-colors decoration-2 underline-offset-4 hover:underline">
            Register now
          </Link>
        </p>
      </form>
